...
import { FaSignOutAlt, FaInfoCircle, FaQuestionCircle } from 'react-icons/fa';
...
const TechnicianNavbar = () => {
  ...
  const routes = [
    ...
    { name: 'Earnings', path: '/technician/earnings' },
        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            <div className="flex-shrink-0 flex items-center">
              <Link href="/technician" className="text-xl font-bold text-blue-600">
                ServiceConnect
              </Link>
            </div>
          </div>
